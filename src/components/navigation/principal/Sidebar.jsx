...
const PrincipalSidebar = () => {
  ...
  const menuItems = [
    ...
    { title: "Staff Mgmt", path: "/dashboard/principal/staff", icon: Users },
    { title: "Welfare", path: "/dashboard/principal/welfare", icon: Heart },
    { title: "Events", path: "/dashboard/principal/events", icon: Calendar },
