...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const menuItems = [
    { name: "Behavior Logs", path: "/dashboard/counselor/behavior", icon: <ClipboardList size={20} /> }, // Screen 1
    { name: "Intervention Cases", path: "/dashboard/counselor/cases", icon: <ShieldCheck size={20} /> }, // Screen 2
    { name: "Wellbeing Trends", path: "/dashboard/counselor/wellbeing", icon: <HeartPulse size={20} /> }, // Screen 3
    { name: "Collaboration Hub", path: "/dashboard/counselor/collaboration", icon: <Users size={20} /> }, // Screen 4
  ];
    ...
    <>
      ...
      <div className="h-full w-full rounded-3xl bg-gradient-to-b from-cyan-400 via-blue-400 to-pink-400 p-4 flex flex-col text-white shadow-2xl relative overflow-hidden">
        ...
        <div className="mt-4 pt-4 border-t border-white/20 relative z-10">
          ...
          >
            <div className="w-8 h-8 rounded-full bg-white text-blue-500 flex items-center justify-center font-bold text-xs">C</div>
            <div className="flex-1">
              <p className="text-sm font-semibold">Counselor</p>
              <p className="text-[10px] opacity-80">:: Confidential</p>
            </div>
            <LogOut size={16} />
          </div>
        </div>
