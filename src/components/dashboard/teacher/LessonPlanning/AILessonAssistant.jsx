...
const AILessonAssistant = ({ aiSuggestions }) => {
  return (
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-6">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm opacity-90 mb-3">
            Based on your "Intro to Kinematics" lesson, we suggest:{" "}
            <strong>"Video: Motion in One Dimension"</strong> and{" "}
            <strong>"Worksheet: Velocity-Time Graphs"</strong>
          </p>
...
export default AILessonAssistant;
