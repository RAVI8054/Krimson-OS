        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
             <div className="bg-white/60 backdrop-blur-xl rounded-[2.5rem] p-8 text-slate-800 relative overflow-hidden shadow-xl shadow-blue-900/5 mb-8 border border-white/50">
                <div className="relative z-10 max-w-2xl">
                  ...
                  <h1 className="text-4xl font-bold mb-4 text-black">Academic Coordinator Dashboard</h1>
                  <p className="text-slate-600 text-lg">Welcome, Academic Coordinator. Here is your consolidated daily summary.</p>
                </div>
              </div>
