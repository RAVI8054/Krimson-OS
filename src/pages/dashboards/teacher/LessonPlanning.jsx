  ...
  return (
    <div className="space-y-6 md:space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-white p-4 md:p-6 rounded-3xl shadow-sm border-l-4 border-cyan-400 hover:shadow-md transition-all">
        ...
        <div className="bg-white p-4 md:p-6 rounded-3xl shadow-sm border-l-4 border-green-400 hover:shadow-md transition-all">
          <div className="flex items-center justify-between mb-2">
        ...
        <div className="bg-white p-4 md:p-6 rounded-3xl shadow-sm border-l-4 border-orange-400 hover:shadow-md transition-all">
          <div className="flex items-center justify-between mb-2">
        ...
        <div className="bg-white p-4 md:p-6 rounded-3xl shadow-sm border-l-4 border-purple-400 hover:shadow-md transition-all">
          <div className="flex items-center justify-between mb-2">
