  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center bg-white p-6 rounded-3xl shadow-sm">
         ...
         <button className="bg-slate-800 text-white px-6 py-3 rounded-xl font-bold hover:bg-slate-900 shadow-lg flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
               ...
               {[1, 2].map(i => (
                 <div key={i} className="border border-slate-100 rounded-2xl p-5 hover:bg-slate-50 transition-colors">
                    <div className="flex justify-between items-start mb-2">
                       ...
                       <span className="bg-blue-100 text-blue-700 px-2 py-1 rounded text-[10px] font-bold uppercase">Scheduled</span>
                    </div>
         ...
         <div className="bg-white rounded-3xl p-8 shadow-sm h-full">
            <h3 className="font-bold text-slate-800 mb-6 flex items-center gap-2">
              <CheckCircle className="text-green-500" /> Completed & Grading
            </h3>
            <div className="space-y-4">
               <div className="bg-green-50/50 rounded-2xl p-5 border border-green-100">
                  ...
                  <button className="w-full py-2 bg-white text-green-700 font-bold rounded-xl text-xs hover:shadow-sm">Review & Publish Options</button>
               </div>
            </div>
         </div>
      </div>
