...
const WelcomeLanding = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-blue-50 to-cyan-50 font-sans text-slate-800">
            {/* Navbar / Header */}
            ...
            <main className="max-w-7xl mx-auto p-6 sm:p-10">
                ...
                {/* Welcome Section */}
                <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-r from-blue-600 to-indigo-700 text-white shadow-2xl shadow-blue-900/20 p-8 sm:p-12 mb-10">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
                        <div>
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    <p className="text-blue-100 font-medium text-lg">Welcome back,</p>
                        ...
                        <div className="text-right">
                            <p className="text-blue-200 text-sm font-medium uppercase tracking-wider mb-1">Singapore Standard Time</p>
                            <div className="text-4xl sm:text-6xl font-mono font-bold leading-none tracking-tight">
                                {time.toFormat("HH:mm")}
                            </div>
                            <p className="text-blue-100 text-lg mt-1">{time.toFormat("EEEE, d MMMM yyyy")}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                    ...
                    <div className="group p-6 bg-white rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:shadow-purple-900/5 hover:border-purple-100 transition-all cursor-pointer">
                    ...
                    <div className="group p-6 bg-white rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:shadow-emerald-900/5 hover:border-emerald-100 transition-all cursor-pointer">
                    ...
                    <div className="group p-6 bg-white rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:shadow-amber-900/5 hover:border-amber-100 transition-all cursor-pointer">
