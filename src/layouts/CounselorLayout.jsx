      ...
      <div className="flex-1 md:ml-72 p-8 overflow-x-hidden">
        ...
        <header className="flex justify-between items-center mb-10">
          ...
          <div className="flex items-center gap-5">
            ...
            <Link to="/dashboard/counselor/profile" className="flex items-center gap-3 bg-white p-1.5 pr-4 rounded-full shadow-sm cursor-pointer hover:shadow-md transition-shadow">
