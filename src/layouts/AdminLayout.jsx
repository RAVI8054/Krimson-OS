        ...
        <header className="h-24 flex items-center justify-between px-8 z-10 sticky top-0">
          ...
          <div className="flex items-center gap-5">
             <div className="hidden md:flex items-center gap-3 bg-white px-5 py-3 rounded-full shadow-sm border border-slate-100 min-w-[320px] hover:shadow-md transition-all group">
                ...
                <input type="text" placeholder="Search across all apps..." className="bg-transparent border-none text-sm outline-none w-full placeholder-slate-400 text-slate-600" />
             </div>
             <button className="relative w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-sm border border-slate-100 hover:shadow-md transition-all hover:bg-slate-50 group">
